...
class Main(Cog_Extension):
    ...
    async def em(self, ctx):
        embed=discord.Embed(title="About", url="https://pbs.twimg.com/media/FUFDb1MVUAEmPQy?format=jpg&name=4096x4096", description="About the bot", color=0x1adff9, timestamp=datetime.datetime.now())
